        ...
        <div class="title">Update Adhar</div>
          ...
          <div class="user__details">
            <div class="input__box">
              ...
              <input type="text" placeholder="Prey" required runat="server" ID="Oname">
            </div>
            <div class="input__box">
              <span class="details">New Name</span>
              <input type="text" placeholder="Dhruv" required runat="server" ID="Nname">
            </div>
            <div class="input__box">
                <span class="details">Old Email</span>
                <input type="email" placeholder="Dhruv@hotmail.com" required runat="server" ID="Oemail">
              </div>
            <div class="input__box">
              <span class="details">New Email</span>
              <input type="email" placeholder="DDhru@hotmail.com" required runat="server" ID="Nemail">
            </div>
            <div class="input__box">
