        ...
        <div class="container">
            ...
            <div class="item-container">
             ...
             <div class="form-input">
                    ...
                    <input ID="dob_input" type="date" class="textbox" runat="server" style="height:50px; border-radius:10px;" aria-required="true" Width="100px"  Text="Enter Your emailID" required />
            </div>
                <div class="form-input">
