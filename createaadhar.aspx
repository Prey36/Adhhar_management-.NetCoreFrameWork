        ...
        <div class="title">Create New Adhar</div>
          ...
          <div class="user__details">
            <div class="input__box">
              ...
              <input type="text" placeholder="Name Surname" required runat="server" ID="Fullname">
            </div>
            <div class="input__box">
              <span class="details">Username</span>
              <input type="text" placeholder="Name" required runat="server" ID="Username">
            </div>
            <div class="input__box">
              <span class="details">Email</span>
              <input type="email" placeholder="example@gmail.com" runat="server" required ID="Email">
            </div>
            <div class="input__box">
