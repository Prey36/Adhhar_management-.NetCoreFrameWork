<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisplayAdhar.aspx.cs" Async="true" Inherits="Addhar_management.DisplayAdhar" %>
...
<body>
    ...
    <form id="form1" runat="server">
      ...
      <asp:GridView ID="QueryDisplay" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <a href="home.html">home.html</a>Download Adharcard<br />
        <input id="adharcard_Input" type="text" runat="server" /><asp:Button ID="adharcardImg_Btn" runat="server" OnClick="getAdharBtn_Click" Text="Create Adhar" />
        ...
        <br />
        <asp:Button ID="getAdhar_Btn" runat="server" OnClick="onGetAdhar_Click" Text="Get Adharr" />
